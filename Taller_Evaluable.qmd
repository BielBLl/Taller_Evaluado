...
pre_estancia_hospitales<-data.frame(
  #4 Cuantitativas 
...
estancia_hospitales<-merge(pre_estancia_hospitales,duracion)
estancia_hospitales<-rename(estancia_hospitales,duracion_estancia=y)
glimpse(estancia_hospitales)
```
